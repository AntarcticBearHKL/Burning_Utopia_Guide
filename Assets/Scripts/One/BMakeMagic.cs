    ...
    public void trigger(SceneOneManager sm)
    {
        ...
        if (dm != null)
        {
            ...
            startDialogs = new List<DialogData> {
                ...
                new DialogData("happy你好，我是桑，专治你的不开心！", speo, 0.65f, null, 0.74f),
                new DialogData("不开心不是一种病，为什么要治；一直开心是一种病，为什么不治？", null, 0.65f, spec, 0.74f),
                new DialogData("----(智慧，我有点害怕了)----", null, 0.65f, null, 0.74f),
                new DialogData("你是那个想要开心魔法的人类？", null, 0.65f, spec, 0.74f),
                new DialogData("命运！你想要快乐，而我却追逐哀伤", null, 0.65f, spec, 0.74f),
                new DialogData("想要不开心，不是一件很容易的事吗？比如被信任的人背叛，每天做无聊的工作，吃不饱饭", speo, 0.65f, null, 0.74f),
                new DialogData("有办法了，你饿上几顿，或者去撞树，求而不得，也是一种不开心", speo, 0.65f, null, 0.74f),
                new DialogData("精灵不用吃饭，吃糖只是为了开心；精灵也不会死，撞树只会痛", null, 0.65f, spec, 0.74f),
