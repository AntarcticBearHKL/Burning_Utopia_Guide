    ...
    public void trigger(STManager sm)
    {
        ...
        if (dm != null)
        {
            ...
            startDialogs = new List<DialogData> {
                ...
                new DialogData("你好，请问你有看到公主吗？", speo, 0.65f, null, 0.65f),
                new DialogData("您对公主的情感真是令人感动，但很抱歉我无法帮助您", null, 0.65f, spec, 0.65f),
                new DialogData("顺便一说，您这身盔甲很漂亮", null, 0.65f, spec, 0.65f),
                new DialogData("真……真的吗？这是我自己用废弃的材料拼装的，第一次得到专业人士的肯定！", speo, 0.65f, null, 0.65f),
